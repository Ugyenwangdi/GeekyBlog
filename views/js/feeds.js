...
var el = document.querySelector('.frame-5-ixv')
...
if (obj._id) {
    ...
    el2.innerHTML = '<a href="#" id = "logout" class="about-fx2">Logout</a>' 
    ...
    el.innerHTML = '<a  href="/login" class="frame-6-52n">Login</a> <a  href="/signup" class="frame-3-XQa">Register</a> '
