...
var el = document.querySelector('.frame-5-kQz')
...
if (obj._id) {
    ...
    el2.innerHTML = '<a href="#" id = "logout" class="about-aqG">Logout</a>' 
    ...
    el.innerHTML = '<a  href="/login" class="frame-6-JhQ">Login</a><a  href="/signup" class="frame-3-mqt">Register</a>'
